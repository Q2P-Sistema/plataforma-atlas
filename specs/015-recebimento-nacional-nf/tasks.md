...
- [ ] T059 Executar o roteiro de `specs/015-recebimento-nacional-nf/quickstart.md`, cenários 1 a 8, contra o ambiente de desenvolvimento — **parcial em UAT (24/09/2026), com OMIE real**:
  ...
  - [ ] Cenário 6 (idempotência): a instrução original estava errada — a fila só lista NF com item pendente, então uma NF inteiramente recebida **não aparece mesmo**, e isso é o comportamento correto. Refeito no roteiro com a NF 71347 (APTA, 3 itens): receber 1 item, confirmar que a NF segue na fila com os outros 2 e que o recebido aparece "Já recebido". Prova idempotência **por item** + fila parcial (FR-030).
